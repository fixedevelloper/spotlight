...
class SessionMeterServiceJunitTest {
    ...
    void testProcess_NumberType_Success() throws Exception {
        ...
        try (MockedStatic<OCRUtil> ocrMock = mockStatic(OCRUtil.class)) {
            ...
            System.out.println("=== testProcess_NumberType_Success ===");
            ...
            // Vérifier l'objet passé au repository
            ...
            System.out.println("Saved to repository: " + captured);
        }
    }
    ...
    void testProcess_IndexType_Success() throws Exception {
        ...
        try (MockedStatic<OCRUtil> ocrMock = mockStatic(OCRUtil.class)) {
            ...
            // Affichage des valeurs
            System.out.println("=== testProcess_IndexType_Success ===");
            System.out.println("Response: " + response);
    ...
    void testProcess_InvalidType_ShouldNotFail() throws Exception {
        ...
        try (MockedStatic<OCRUtil> ocrMock = mockStatic(OCRUtil.class)) {
            ...
            // Affichage des valeurs
            System.out.println("=== testProcess_InvalidType_ShouldNotFail ===");
            System.out.println("Response: " + response);
